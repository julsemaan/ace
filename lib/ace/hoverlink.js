...
(function(){
    ...
    this.update = function(e) {
        ...
        if(e.ctrlKey) {
          ...
          editor.renderer.container.setAttribute("title", "Tip: You can ctrl-click this link to open it in a new tab");
        }
    ...
    this.clear = function() {
        if (this.isOpen) {
            ...
            //this.editor.renderer.container.setAttribute("title", "");
            this.isOpen = false;
        }
    };
